...
from constants import STATE_CHOICES, TYPE_CHOICES, USER_TYPE_CHOICES
...
class User(AbstractUser):
    """
    Стандартная модель поьзователей
    """
...
class Contact(models.Model):
    type = models.CharField(max_length=255, choices=TYPE_CHOICES, default="Почта")
